...
export const teaOptions = [
  ...
  { name: "Chai", caffeine: 50 },
  { name: "Drip Coffee", caffeine: 150 },
  { name: "Espresso", caffeine: 80 },

  { name: "Americano", caffeine: 75 },
  { name: "Cappuccino", caffeine: 75 },
